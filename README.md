...
```bash
go get -u github.com/ilovelili/go-aws-sdk
```
...
```Go
import github.com/ilovelili/go-aws-sdk
...
Use *AsyncSend*, *AsyncReceive*, *AsyncDelete* to handle SQS operation request concurrently
